...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <h1 class="text-xl font-semibold">Editar imagen · {{ $product->name }}</h1>
    ...
    <div class="bg-white border rounded-lg p-6 space-y-6">
        ...
        <form method="POST" action="{{ route('admin.products.images.update', [$product, $image]) }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
            @method('PUT')
            <div>
